...
describe('RomanNumerals', () => {
  ...
  describe('convert from arabic to roman', () => {
    it('should convert 1 to I', () => {
      expect(converter.convert(1)).to.equal('I');
    });
    it('should convert 2 to II', () => {
      expect(converter.convert(2)).to.equal('II');
    });
    it('should convert 3 to III', () => {
      expect(converter.convert(3)).to.equal('III');
    });
    it('should convert 4 to IV', () => {
      expect(converter.convert(4)).to.equal('IV');
    });
    it('should convert 5 to V', () => {
      expect(converter.convert(5)).to.equal('V');
    });
    it('should convert 9 to IX', () => {
      expect(converter.convert(9)).to.equal('IX');
    });
    it('should convert 10 to X', () => {
      expect(converter.convert(10)).to.equal('X');
    });
    it('should convert 40 to XL', () => {
      expect(converter.convert(40)).to.equal('XL');
    });
    it('should convert 50 to L', () => {
      expect(converter.convert(50)).to.equal('L');
    });
    it('should convert 90 to XC', () => {
      expect(converter.convert(90)).to.equal('XC');
    });
    it('should convert 100 to C', () => {
      expect(converter.convert(100)).to.equal('C');
    });
    it('should convert 400 to CD', () => {
      expect(converter.convert(400)).to.equal('CD');
    });
    it('should convert 500 to D', () => {
      expect(converter.convert(500)).to.equal('D');
    });
    it('should convert 900 to CM', () => {
      expect(converter.convert(900)).to.equal('CM');
    });
    it('should convert 1000 to M', () => {
      expect(converter.convert(1000)).to.equal('M');
    });
    ...
    it('should throw error if value is less than 0', () => {
      expect(() => converter.convert(-1)).to.throw(Error);
    });
    it('should convert 3999 to MMMCMXCIX', () => {
      expect(converter.convert(3999)).to.eql('MMMCMXCIX');
    });
    ...
    it('should throw error if value is not a number or a string', () => {
      expect(() => converter.convert(true)).to.throw(Error);
    });
  });
  ...
  describe('convert from roman to arabic', () => {
    ...
    it('should throw error if value is empty string', () => {
      expect(() => converter.convert('')).to.throw(Error);
    });
    it('should throw error if value is less than 1', () => {
      expect(() => converter.convert('-MMXIII')).to.throw(Error);
    });
