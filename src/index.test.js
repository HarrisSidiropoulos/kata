...
describe('RomanNumerals', () => {
  ...
  describe('convert from arabic to roman', () => {
    ...
    it('should convert 7 to VII', ()=> {
      expect(converter.convert(7)).to.be.equal('VII');
    });
    it('should convert 8 to VIII', ()=> {
      expect(converter.convert(8)).to.be.equal('VIII');
    });
    ...
    it('should convert 11 to XI', ()=> {
      expect(converter.convert(11)).to.be.equal('XI');
    });
    ...
    it('should convert 50 to L', ()=> {
      expect(converter.convert(50)).to.be.equal('L');
    });
    it('should convert 90 to XC', ()=> {
      expect(converter.convert(90)).to.be.equal('XC');
    });
    it('should convert 100 to C', ()=> {
      expect(converter.convert(100)).to.be.equal('C');
    });
    it('should convert 400 to CD', ()=> {
      expect(converter.convert(400)).to.be.equal('CD');
    });
    it('should convert 500 to D', ()=> {
      expect(converter.convert(500)).to.be.equal('D');
    });
    it('should convert 900 to CM', ()=> {
      expect(converter.convert(900)).to.be.equal('CM');
    });
